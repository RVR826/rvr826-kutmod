...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{res_error_increase.png}
    \caption{Residual error $\|PA - LU\|_F$ increase for matrix sizes.}
    \label{fig:residual_inc}
\end{figure}
...
around $10^{-12}$ at $n = 1000$. The increase of the residual error can be seen on Figure~\ref{fig:residual_inc}. These values remain extremely small relative to the size and magnitude of the matrices. 
